...
def arg_parse():
    parser = argparse.ArgumentParser(
        description="Tools to visualize semantic segmentation map."
    )

    # Datasets parameters
    parser.add_argument(
        "--sat_path", type=str, default="", help="path to RGB satellite image"
    )
    parser.add_argument("--mask_path", type=str, default="", help="path to mask")
