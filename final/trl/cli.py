...
def main():
    ...
    if args.command == "dpo":
        ...
        dpo_training_script = os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "scripts", "dpo.py"
        )
        ...
        # Get the default args for the launch command
        kto_training_script = os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "scripts", "kto.py"
        )
        ...
        # Get the default args for the launch command
        sft_training_script = os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "scripts", "sft.py"
        )
