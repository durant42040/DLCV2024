...
class CPOTrainer(Trainer):
    ...
    def __init__(
        ...
        if args.model_init_kwargs is None:
            ...
            raise ValueError(
                "You passed model_kwargs to the CPOTrainer. But your model is already instantiated."
            )
        else:
        ...
        if processing_class is None:
            raise ValueError(
                "processing_class must be specified to tokenize a CPO dataset."
            )
        ...
        if args.loss_type == "kto_pair":
            raise ValueError(
                "Support for kto_pair has been removed in CPOTrainer. Please use KTOTrainer."
            )
